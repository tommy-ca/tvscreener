...
from tvscreener_ext.screeners.renderers.base import BaseRenderer
from tvscreener_ext.utils.logic import to_scalar
...
class RichConsoleRenderer(BaseRenderer):
    ...
    def render(self, screener: Any, results_df: pd.DataFrame | None = None, **kwargs: Any) -> None:
        ...
        from tvscreener_ext.screeners.export_helpers import print_summary
    ...
    def _render_opportunity(
        ...
        from tvscreener_ext.constants.forex import DEFAULT_LIMIT_SUMMARY
    ...
    def _render_opportunity_detailed(
        ...
        from tvscreener_ext.constants.forex import DEFAULT_LIMIT_DETAILED
    ...
    def _render_opportunity_matrix(
        ...
        from tvscreener_ext.constants.forex import DEFAULT_LIMIT_MATRIX
